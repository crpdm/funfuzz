#!/usr/bin/env python
# coding=utf-8
# pylint: disable=cell-var-from-loop,fixme,global-statement,missing-docstring,no-member,too-many-arguments
...
def compareLevel(jsEngine,  # pylint: disable=invalid-name
...
def diffFiles(f1, f2):  # pylint: disable=invalid-name

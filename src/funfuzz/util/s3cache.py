...
def isEC2VM():  # pylint: disable=invalid-name
...
class S3Cache(object):
    ...
    def downloadFile(self, origin, dest):  # pylint: disable=invalid-name
    ...
    def compressAndUploadDirTarball(self, directory, tarball_path):  # pylint: disable=invalid-name
    ...
    def uploadFileToS3(self, filename):  # pylint: disable=invalid-name
        """Upload file to S3."""
    ...
    def uploadStrToS3(self, destDir, filename, contents):  # pylint: disable=invalid-name
